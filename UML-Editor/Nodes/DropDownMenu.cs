...
{
    public class DropDownMenu : IRenderableNode, IKeyboardHandlerNode
    {
        ...
        public DropDownMenu(string name, Vector position, int width, int height, RectangleRenderElementStyle style)
        {
            Name = name;
            Position = position;
