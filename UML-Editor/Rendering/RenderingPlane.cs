...
namespace UML_Editor.Rendering
{
    public class RenderingPlane
    {
        ...
        public RenderingPlane(PictureBox pic)
        {
            plane = pic;
            width = plane.Width;
            height = plane.Height;
        ...
        public void DrawArrow(Vector from, Vector to, Pen draw_pen)
        {
            using (Graphics g = GetGraphics())
            {
        ...
        public void DrawRectangleCentre(Vector position, int width, int height, Pen draw_pen, Brush fill_brush = null)
        {
